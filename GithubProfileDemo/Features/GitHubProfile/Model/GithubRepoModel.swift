...
struct GithubRepoModel: Codable, Hashable {
    let id: Int
    let nodeID, name, fullName: String
    let githubProjectPrivate: Bool
    let htmlURL: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case githubProjectPrivate = "private"
...
enum ProgrammingLanguage: Codable, Hashable {
    case javaScript
    case java
    case python
    case html
    ...
    var color: Color {
        switch self {
        case .javaScript: return .blue
        case .java: return .red
        case .python: return .green
        case .html: return .yellow
        case .cplusplus: return .purple
        case .c: return .orange
        case .dart: return .pink
